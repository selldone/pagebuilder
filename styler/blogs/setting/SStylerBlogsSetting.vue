  ...
  >
    <v-card flat class="text-start">
      ...
      <v-card-text class="pb-16">
        <!-- ████████████████████ Sort ████████████████████ -->
        <s-setting-group title="Sort" subtitle="Set how to sort blogs to show.">
          <s-setting-select
            :items="SortKEys"
        ...
        <!-- ████████████████████ Filter ████████████████████ -->
        <s-setting-group title="Filter" subtitle="Filter by tags and search.">
          <!-- ▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅ Tags ▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅ -->
          <s-setting-combobox
...
export default {
  ...
  beforeUnmount() {
    this.EventBus.$off("show:SStylerBlogsSetting");
